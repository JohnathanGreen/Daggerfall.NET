...
{
    /// <summary>
    /// This is the source of the entire graphics system. It provides rendering and is necessary for constructing any <see cref="GraphicsResource"/>.
    /// </summary>
    public class GraphicsDevice : IDisposable
    {
        ...
        /// <summary>
        /// Get a collection of <see cref="Texture"/> objects that have been assigned to the texture stages. If using <see cref="Effect"/>s, this collection is automatically updated.
        /// </summary>
        /// <remarks>
        /// Note that at draw time, a render target cannot be set as a render target and a texture at a stage. In other words, you cannot read and write a render target simultaneously.
        /// </remarks>
        /// <example>
        /// This is an example of using registers in an effect file to explicitly set which register to use:
        /// <code>
        /// Texture3D texture;
        /// GraphicsDevice.Textures[4] = texture;
        /// </code>
        /// 
        /// You can then use this register to assign your texture directly:
        /// <code>
        /// sampler mySampler : register(s4);
        /// </code>
        /// </example>
        ...
        /// <summary>
        /// Get a collection of <see cref="SamplerState"/> objects that determine how to sample a <see cref="Texture"/> at the same <see cref="Textures"/> index. If using <see cref="Effect"/>s, this collection is automatically updated and is described in an HLSL "sampler"
        /// </summary>
        /// <remarks>
        /// </remarks>
